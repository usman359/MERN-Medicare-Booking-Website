            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text_para">
                  ...
                  asperiores? Eaque, magnam delectus. Labore consectetur debitis
                  hic temporibus dolorum saepe, enim voluptatibus! Possimus eum
                  debitis explicabo eos, voluptatum deleniti iste?
                </p>
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text_para">
                  3. Viw our physician who are accepting new patients, use the
